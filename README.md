...
## Description
The following assignment provided code that was already available, and my challenge was to refactor this code to make it "DRY".  DRY means "don't repeat yourself".  We want other developers who are possibly viewing our code in the future to be able to easily understand it, manipulate it, and critique it.  The code provided was written with non-semantic tags, had a style sheet that was repetitive, and overall the HTML and CSS were difficult to understand at first glance.  I've refactored the code and commented on both my stylesheet and my HTML file of the changes I've made, and added alt tags to the images.
